...
public class EditProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager=new LinearLayoutManager(EditProducts.this);
    ...
    private void loadData() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //adapter
                adapterProduct= new AdapterProduct(EditProducts.this, productList,2);
                recyclerView.setLayoutManager(new LinearLayoutManager(EditProducts.this, LinearLayoutManager.VERTICAL, false));
